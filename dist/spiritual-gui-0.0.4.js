...
gui.Spiritual.prototype = {
	 ...
	 * * Extend Element.prototype in window
	 * * Declare local ui object in window
	 * * Declare spirit world objects, pointing back to this window
...
/**
 * #gui.Position
 * Something that has 2D position.
 * @param {number} x
 * @param {number} y
 */
